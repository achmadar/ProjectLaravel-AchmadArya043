                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mr-4 ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" placeholder="Enter kategori" value="{{ old('nama_kategori') }}">    
                                </div>
